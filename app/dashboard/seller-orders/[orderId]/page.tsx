...
import { StatusCard } from "@/components/dashboard/seller-orders/status-card";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
        ...
        <div className="w-full space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-[1fr_250px] lg:grid-cols-3 lg:gap-8">
                ...
                <div className="space-y-6">
                        ...
                        <CardContent className="">
                            <div className="space-y-4">
                                <div className="flex items-center justify-between gap-2 border-t">
                                    <div>Items {order.orderProducts.length}</div>
                    ...
                    <StatusCard id={params.orderId} products={order.orderProducts} />
                </div>
            </div>
        </div>
    )
