...
import { StatusCard } from "@/components/dashboard/order/status-card";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
                        ...
                        <CardFooter className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between p-4">
                            <div className="flex flex-col gap-1 text-sm">
                                <div className="flex items-center gap-2">
                                    Total
                                    <span className="text-base font-semibold">&#2547;{order.totalAmount + order.deliveryFee}</span>
                                </div>
                            </div>
                        </CardFooter>
                    </Card>
                    <StatusCard id={params.orderId} products={order.products} />
                </div>
            </div>
        </div>
    )
